...
... _datastoreName_
.... **Definition** -> `dns` member key that specifies what datastore items should be prefixed with.
.... **Schema** -> JSON string. Must use a Kubernetes-compatible schema.
...
... _pemExt_
.... **Definition** -> `fs` member key that specifies the file extension to use for exported PEM certificate-key combos.
.... **Schema** -> JSON string
...
... _datastore_
.... **Definition** -> `server` member key that specifies how log data is stored.
.... **Schema** -> JSON Object that contains the following keys:

..... _type_
...... **Definition** -> `datastore` member key that specifies the type of datastore to use.
...... **Schema** -> JSON string. Must be one of the following -> [none, file, elasticstack, mongodb, postgresql]

..... _networkAddress_
...... **Definition** -> `datastore` member key that specifies the IPv4 network address of the datastore.
...... **Schema** -> JSON string. Must be a valid IPv4 network prefix.
...
..... _configs_
...... **Definition** -> `datastore` member key that specifies datastore-specific configurations.
...... **Schema** -> JSON Object that contains the following keys:

....... _elasticstack_
........ **Definition** -> `configs` member key that specifies settings for ElasticStack datastore.
........ **Schema** -> JSON Object that contains the following keys:

......... _logstashImage_
.......... **Definition** -> `elasticstack` member key that specifies the image to use for a LogStash container.
.......... **Schema** -> JSON string. Must be either a Docker Hub relative image or a full image name with the registry, namespace, and repository. Tag/hash is optional.

......... _elasticsearchImage_
.......... **Definition** -> `elasticstack` member key that specifies the image to use for a ElasticSearch container.
.......... **Schema** -> JSON string. Must be either a Docker Hub relative image or a full image name with the registry, namespace, and repository. Tag/hash is optional.

......... _kibanaImage_
.......... **Definition** -> `elasticstack` member key that specifies the image to use for a Kibana container.
.......... **Schema** -> JSON string. Must be either a Docker Hub relative image or a full image name with the registry, namespace, and repository. Tag/hash is optional.

....... _file_
........ **Definition** -> `configs` member key that specifies settings for remote file datastore.
........ **Schema** -> JSON Object that contains the following keys:

......... _format_
.......... **Definition** -> `file` member key that specifies the file format to use for saving logs.
.......... **Schema** -> JSON string. Must be one of the following -> [csv].

......... _logFolder_
.......... **Definition** -> `file` member key that specifies the filesystem directory to use for saving logs.
.......... **Schema** -> JSON string. Must be a UNIX-valid absolute filepath.

......... _datastoreName_
.......... **Definition** -> `file` member key that specifies the name of the file preferred for saving datastore logs.
.......... **Schema** -> JSON string. Must be a UNIX-valid file name.

......... _defaultName_
.......... **Definition** -> `file` member key that specifies the name of the default file for saving datastore logs.
.......... **Schema** -> JSON string. Must be a UNIX-valid file name.

......... _operationsName_
.......... **Definition** -> `file` member key that specifies the name of the file preferred for saving server operation logs.
.......... **Schema** -> JSON string. Must be a UNIX-valid file name.

....... _mongodb_
........ **Definition** -> `configs` member key that specifies settings for MongoDB datastore.
........ **Schema** -> JSON Object that contains the following keys:

......... _image_
.......... **Definition** -> `mongodb` member key that specifies the image to use for a MongoDB container.
.......... **Schema** -> JSON string. Must be either a Docker Hub relative image or a full image name with the registry, namespace, and repository. Tag/hash is optional.

....... _postgresql_
........ **Definition** -> `configs` member key that specifies settings for PostgreSQL datastore.
........ **Schema** -> JSON Object that contains the following keys:

......... _image_
.......... **Definition** -> `postgresql` member key that specifies the image to use for a PostgreSQL container.
.......... **Schema** -> JSON string. Must be either a Docker Hub relative image or a full image name with the registry, namespace, and repository. Tag/hash is optional.
