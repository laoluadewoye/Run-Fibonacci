...
* Added new environmental variables `SERVER_DATASTORE`, `DATASTORE_ADDRESS`, and `DATASTORE_PORT`  to support multiple kinds of datastores.
...
* Added skeleton for new log saving API to `rest.py`.
